! function(e) {
    ...
    var t = {
        ...
        init: function(t, n) {
            this.$el = e(n), this.$el.addClass("jquery-comments"), this.undelegateEvents(), this.delegateEvents(),
                function(e) {
        ...
        fetchDataAndRender: function() {
            var t = this;
            this.$el.empty(), this.createHTML(), this.commentsById = {};
            var n = function(n) {
                    var a = n.map(function(e) {
                        return t.createCommentModel(e)
                    });
                    t.sortComments(a, "oldest"), e(a).each(function(e, n) {
        ...
        addCommentToDataModel: function(e) {
            if (!(e.id in this.commentsById) && (this.commentsById[e.id] = e, e.parent)) {
                var t = this.getOutermostParent(e.parent);
                t.childs.push(e.id)
            }
        },
        ...
        render: function() {
            this.showActiveContainer(), this.createComments(), this.options.enableAttachments && this.createAttachments(), this.$el.find("> .spinner").remove(), this.options.refresh()
        },
        showActiveContainer: function() {
            var e = this.$el.find(".navigation li[data-container-name].active"),
                t = e.data("container-name"),
                n = this.$el.find('[data-container="' + t + '"]');
            n.siblings("[data-container]").hide(), n.show()
        },
        ...
        uploadAttachments: function(t, n) {
            ...
            if (o) {
                ...
                e(t).each(function(e, t) {
                    ...
                    n.id += "-" + e, n.content = "", n.file = t, n.fileURL = "C:/fakepath/" + t.name, n.fileMimeType = t.type, n = a.applyExternalMappings(n), m.push(n)
                }), a.options.uploadAttachments(m, c, p)
            }
            r.find("input").val("")
        },
        updateToggleAllButton: function(t) {
            var n = t.find(".child-comments"),
                a = n.find(".comment"),
                i = n.find("li.toggle-all");
            a.removeClass("hidden-reply");
            var o = a.slice(0, -this.options.maxRepliesVisible);
        ...
        sortAndReArrangeComments: function(t) {
            var n = this.$el.find("#comment-list"),
                a = this.getComments().filter(function(e) {
                    return !e.parent
                });
        ...
        saveOnKeydown: function(t) {
            if (13 == t.keyCode) {
                ...
                if (this.options.postCommentOnEnter || n) {
                    ...
                    a.siblings(".control-row").find(".save").trigger("click"), t.stopPropagation(), t.preventDefault()
                }
            }
        },
        ...
        navigationElementClicked: function(t) {
            var n = e(t.currentTarget),
                a = n.data().sortKey;
            "attachments" != a && this.sortAndReArrangeComments(a), this.currentSortKey = a, this.showActiveSort()
        },
        toggleNavigationDropdown: function(t) {
            t.stopPropagation();
            var n = e(t.currentTarget).find("~ .dropdown");
            n.toggle()
        },
        showMainCommentingField: function(t) {
            var n = e(t.currentTarget);
            n.siblings(".control-row").show(), n.parent().find(".close").show(), n.focus()
        },
        hideMainCommentingField: function(t) {
            var n = e(t.currentTarget),
                a = this.$el.find(".commenting-field.main .textarea"),
                i = this.$el.find(".commenting-field.main .control-row");
            this.clearTextarea(a), this.adjustTextareaHeight(a, !1), i.hide(), n.hide(), a.blur()
        },
        ...
        textareaContentChanged: function(t) {
            var n = e(t.currentTarget),
                a = this.getTextareaContent(n),
                i = n.siblings(".control-row").find(".save");
            if (!n.find(".reply-to-badge").length) {
                var o = n.attr("data-comment");
                if (o) {
                    var r = n.parents("li.comment");
                    if (r.length > 1) {
                        var s = r.last().data("id");
                        n.attr("data-parent", s)
                    }
                } else {
                    var s = n.parents("li.comment").last().data("id");
                    n.attr("data-parent", s)
                }
            }
            var l = n.parents(".commenting-field").first();
            n[0].scrollHeight > n.outerHeight() ? l.addClass("scrollable") : l.removeClass("scrollable");
            var d = !0;
            if (o = n.attr("data-comment")) {
                var c, p = a != this.commentsById[o].content;
                this.commentsById[o].parent && (c = this.commentsById[o].parent.toString());
                var m = n.attr("data-parent") != c;
                d = p || m
            }
            a.length && d ? i.addClass("enabled") : i.removeClass("enabled")
        },
        removeCommentingField: function(t) {
            var n = e(t.currentTarget),
                a = n.siblings(".textarea");
            a.attr("data-comment") && n.parents("li.comment").first().removeClass("edit");
            var i = n.parents(".commenting-field").first();
            i.remove()
        },
        postComment: function(t) {
            ...
            this.options.postComment(r, s, l)
        },
        ...
        putComment: function(t) {
            ...
            this.options.putComment(r, s, l)
        },
        deleteComment: function(t) {
            var n = this,
                a = e(t.currentTarget),
                i = a.parents(".comment").first(),
                o = e.extend({}, this.commentsById[i.attr("data-id")]),
                r = o.id,
                s = o.parent;
            ...
            this.options.deleteComment(o, l, d)
        },
        fileInputChanged: function(t, n) {
            var n = t.currentTarget.files,
                a = e(t.currentTarget).parents(".commenting-field").first();
            this.uploadAttachments(n, a)
        },
        upvoteComment: function(t) {
            var n, a = this,
                i = e(t.currentTarget).parents("li.comment").first(),
                o = i.data().model,
                r = o.upvoteCount;
            ...
            var l = function(e) {
                ...
                d = function() {
                    o.userHasUpvoted = !o.userHasUpvoted, o.upvoteCount = r, a.reRenderUpvotes(o.id)
                };
            this.options.upvoteComment(s, l, d)
        },
        ...
        createHTML: function() {
            ...
            t.addClass("main"), this.$el.append(t);
            var n = t.find(".control-row");
            n.hide(), t.find(".close").hide(), this.options.enableNavigation && (this.$el.append(this.createNavigationElement()), this.showActiveSort());
            var a = this.createSpinner();
            this.$el.append(a);
            var i = e("<div/>", {
            ...
            if (this.options.noCommentsIconURL.length && (r.css("background-image", 'url("' + this.options.noCommentsIconURL + '")'), r.addClass("image")), o.prepend(e("<br/>")).prepend(r), i.append(o), this.options.enableAttachments) {
                var s = e("<div/>", {
                    "class": "data-container",
                ...
                this.options.attachmentIconURL.length && (d.css("background-image", 'url("' + this.options.attachmentIconURL + '")'), d.addClass("image")), l.prepend(e("<br/>")).prepend(d), s.append(l);
                var c = e("<div/>", {
                ...
                this.options.uploadIconURL.length && (h.css("background-image", 'url("' + this.options.uploadIconURL + '")'), h.addClass("image"));
                var u = e("<div/>", {
                    text: this.options.textFormatter(this.options.attachmentDropText)
                });
                m.append(h), m.append(u), c.html(p.html(m)).hide(), this.$el.append(c)
            }
        },
        ...
        createCommentingFieldElement: function(t, n) {
            var a = e("<div/>", {
                "class": "commenting-field"
            });
            if (n) var i = this.commentsById[n].profilePictureURL;
            else var i = this.options.profilePictureURL;
            var o = this.createProfilePictureElement(i),
                r = e("<div/>", {
            ...
            this.adjustTextareaHeight(l, !1);
            var d = e("<span/>", {
                "class": "close"
            }).append(e('<span class="left"/>')).append(e('<span class="right"/>'));
            if (n) {
                var c = this.options.textFormatter(this.options.saveText),
                    p = e("<span/>", {
                        "class": "delete",
                        text: this.options.textFormatter(this.options.deleteText)
                    }).css("background-color", this.options.deleteButtonColor);
                s.append(p), this.isAllowedToDelete(n) && p.addClass("enabled")
            } else {
                var c = this.options.textFormatter(this.options.sendText);
                if (this.options.enableAttachments) {
                    ...
                    e.browser.mobile || u.attr("multiple", "multiple"), this.options.uploadIconURL.length && (h.css("background-image", 'url("' + this.options.uploadIconURL + '")'), h.addClass("image")), m.append(h).append(u), s.append(m)
                }
            }
            var f = n ? "update" : "send",
                g = e("<span/>", {
                    "class": f + " save highlight-background",
                    text: c
                });
            if (s.prepend(g), r.append(d).append(l).append(s), a.append(o).append(r), t) {
                l.attr("data-parent", t);
        ...
        createCommentElement: function(t) {
            ...
            var a = e("<ul/>", {
                ...
                i = this.createCommentWrapperElement(t);
        ...
        createCommentWrapperElement: function(t) {
            var n = e("<div/>", {
                ...
                a = this.createProfilePictureElement(t.profilePictureURL),
                i = e("<time/>", {
                    text: this.options.timeFormatter(t.created),
                    "data-original": t.created
                }),
                o = t.createdByCurrentUser ? this.options.textFormatter(this.options.youText) : t.fullname,
                r = e("<div/>", {
                    "class": "name"
                });
            if (t.profileURL) {
            ...
            if ((t.createdByCurrentUser || t.createdByAdmin) && r.addClass("highlight-font-bold"), t.parent) {
                var l = this.commentsById[t.parent];
                if (l.parent) {
                    var d = e("<span/>", {
                            "class": "reply-to",
                            text: l.fullname
                    ...
                    this.options.replyIconURL.length && (c.css("background-image", 'url("' + this.options.replyIconURL + '")'), c.addClass("image")), d.prepend(c), r.append(d)
                }
            }
            var p = e("<div/>", {
                    "class": "wrapper"
            ...
            if (h) {
                ...
                if ("image" == f) {
                    ...
                    var b = ["archive", "audio", "code", "excel", "image", "movie", "pdf", "photo", "picture", "powerpoint", "sound", "video", "word", "zip"],
                        x = "fa fa-file-o";
                    b.indexOf(u) > 0 ? x = "fa fa-file-" + u + "-o" : b.indexOf(f) > 0 && (x = "fa fa-file-" + f + "-o");
                    var y = e("<i/>", {
                        "class": x
                    });
                    this.options.fileIconURL.length && (y.css("background-image", 'url("' + this.options.fileIconURL + '")'), y.addClass("image"));
                    var T = t.fileURL.split("/"),
                        w = T[T.length - 1];
                    w = w.split("?")[0], w = decodeURIComponent(w), s.text(w), s.prepend(y)
                }
                m.html(s)
            } else m.html(this.linkify(this.escape(t.content)));
            if (t.modified && t.modified != t.created) {
                var R = this.options.timeFormatter(t.modified),
                    k = e("<time/>", {
                        "class": "edited",
            ...
            if (this.options.enableReplying && U.append($), this.options.enableUpvoting && U.append(L), t.createdByCurrentUser || this.options.currentUserIsAdmin)
                if (h && this.isAllowedToDelete(t.id)) {
                    var D = e("<button/>", {
            ...
            return U.children().each(function(t, n) {
                e(n).is(":last-child") || e(n).after(A.clone())
            }), p.append(m), p.append(U), n.append(a).append(i).append(r).append(p), n
        },
        createUpvoteElement: function(t) {
            var n = e("<i/>", {
                "class": "fa fa-thumbs-up"
            });
            this.options.upvoteIconURL.length && (n.css("background-image", 'url("' + this.options.upvoteIconURL + '")'), n.addClass("image"));
            var a = e("<button/>", {
                "class": "action upvote" + (t.userHasUpvoted ? " highlight-font" : "")
            }).append(e("<span/>", {
                text: t.upvoteCount,
                "class": "upvote-count"
            })).append(n);
        ...
        reRenderComment: function(t) {
            ...
            a.each(function(t, a) {
                ...
                e(a).find(".comment-wrapper").first().replaceWith(o)
            })
        },
        reRenderCommentActionBar: function(t) {
            ...
            a.each(function(t, a) {
                var o = i.createCommentWrapperElement(n);
                e(a).find(".actions").first().replaceWith(o.find(".actions"))
            })
        },
        reRenderUpvotes: function(t) {
            ...
            a.each(function(t, a) {
                ...
                e(a).find(".upvote").first().replaceWith(o)
            })
        },
        ...
        setToggleAllButtonText: function(e, t) {
            var n = this,
                ...
                i = e.find(".caret"),
                o = function() {
                    var t = n.options.textFormatter(n.options.viewAllRepliesText),
                        i = e.siblings(".comment").length;
        ...
        adjustTextareaHeight: function(t, n) {
            ...
            t = e(t);
            var r = 1 == n ? this.options.textareaRowsOnFocus : this.options.textareaRows;
            do {
                o(r), r++;
                var s = t[0].scrollHeight > t.outerHeight(),
        ...
        getTextareaContent: function(t) {
            var n = e("<pre/>").html(t.html());
            n.find("div, p, br").replaceWith(function() {
                return "\n" + this.innerHTML
            });
            var a = n.text().replace(/^\s+/g, "");
            return a
        },
        getTextareaContentAsEscapedHTML: function(e) {
            var t = this.escape(e);
            return t.replace(/(?:\n)/g, "<br>")
        },
        moveCursorToEnd: function(t) {
            if (t = e(t)[0], e(t).trigger("input"), e(t).scrollTop(t.scrollHeight), "undefined" != typeof window.getSelection && "undefined" != typeof document.createRange) {
        ...
        escape: function(t) {
            return e("<pre/>").text(t).html()
        },
        linkify: function(e) {
            var t, n, a, i;
            n = /(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gim, t = e.replace(n, '<a href="$1" target="_blank">$1</a>'), a = /(^|[^\/f])(www\.[\S]+(\b|$))/gim, t = t.replace(a, '$1<a href="http://$2" target="_blank">$2</a>'), i = /(([a-zA-Z0-9\-\_\.])+@[a-zA-Z\_]+?(\.[a-zA-Z]{2,6})+)/gim, t = t.replace(i, '<a href="mailto:$1">$1</a>');
            var o = e.match(/<a href/g) || [];
            if (o.length > 0) {
                for (var r = e.split(/(<\/a>)/g), s = 0; s < r.length; s++) null == r[s].match(/<a href/g) && (r[s] = r[s].replace(n, '<a href="$1" target="_blank">$1</a>').replace(a, '$1<a href="http://$2" target="_blank">$2</a>').replace(i, '<a href="mailto:$1">$1</a>'));
                var l = r.join("");
                return l;
            }
            return t
