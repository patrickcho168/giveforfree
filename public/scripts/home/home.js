        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                $.each(data, function(key, value) {
                    ...
                    if (value.meWant > 0) {
                        html += '<div class="col-lg-12 text-center call-button"><a class="btn btn-sm btn-danger unsnag" itemId="' + value.itemID + '" role="button">UNSNAG</a></div>';
                    } else {
                        html += '<div class="col-lg-12 text-center call-button"><a class="btn btn-sm btn-primary snag" itemId="' + value.itemID + '" role="button">SNAG</a></div>';
                    }
                    // Item Snag Counts
