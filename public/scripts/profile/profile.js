            ...
            success: function(data) {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        // Item Snag Counts
                        if (value.numWants > 1) {
                            html += '<small class="item-snags pull-right muted" align="right" style="padding-right: 10px; padding-top: 0; padding-bottom: 10px;"><b>' + value.numWants + ' people want this.</b></small>';
                        } else {
                            html += '<small class="item-snags pull-right muted" align="right" style="padding-right: 10px; padding-top: 0;padding-bottom: 10px;">' + '<b>Be the first to check this out!</b></small>';
