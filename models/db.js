...
var ItemPageQuery = function(userId, itemId, cb) {
  knex
    ...
    .leftJoin('categoryItem as ci', 'ci.itemID', 'i.itemID')
    .leftJoin('category as cn', 'cn.categoryID', 'ci.categoryID')
    .select(['cn.name as categoryName', 'i.itemID', 'i.timeExpired', 'i.imageLocation', 'i.title', 'i.takerID', 'i.description', 'i.giverID', 'i.meetup', 'i.postage', 'i.collectionMessage', 'i.giverRating', 'i.takerRating', 'i.charityID', 'i.donationAmount', 'c.charityName', 'u.name', 'u.userID', 'u.fbID', 't.name as takerName', 't.userID as takerId', 't.fbID as takerFbID'])
    .count('iw.itemID as numWants')
    .countDistinct('iwu.itemID as meWant')
    .groupBy('i.itemID')
