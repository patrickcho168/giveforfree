...
router.get('/upload', ensureLogin.ensureLoggedIn(), csrfProtection, function(req, res, next) {
...
// Update an item
router.post('/api/update/:itemId',  parseForm, ensureLogin.ensureLoggedIn(), csrfProtection, function(req, res) {
...
router.post('/upload', parseForm, ensureLogin.ensureLoggedIn(), csrfProtection, function(req, res, next) {
